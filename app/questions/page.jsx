...
const Questions = () => {
  ...
  return (
    <section className="flex relative flex-col h-full">
      <div className=" bg-secondary min-h-[234px] max-h-[234px]">
        <Image
              ...
              <div className="flex flex-col gap-[20px] mt-[20px]">
                ...
                {questions[currentQuestion].options.map((option, index) => (
                  ...
                  />
                    ...
                    <p className="text-[20px] font-medium text-text_primary">{option}</p>
                  </div>
                ))}
                <div className="w-full fixed  left-0  mx-auto bottom-[40px] px-[20px] sm:px-[40px] ease-in duration-300 flex items-center justify-center">
                  <CustomButton
                    className="text-white z-[100]  text-[24px] capitalize font-black h-[60px]  max-w-[710px]"
                    title='next'
                    icon={true}
